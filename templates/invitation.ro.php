<?php
/**
 * Gabarit d'e-mail d'invitation — roumain.
...
$subject = 'Julia & Jérémy — 23 octombrie 2027: invitația dumneavoastră';
...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;">Linkul dumneavoastră personal pentru confirmarea prezenței.</div>
...
<tr><td align="center">
  ...
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:#FFFCF6;border:1px solid #EADFCB;">
    ...
    <tr><td align="center" style="padding:20px 36px 0;font-family:Georgia,'Times New Roman',serif;">
      <p style="margin:0;font-size:11px;letter-spacing:5px;text-transform:uppercase;color:#B08D57;">Rezervați data</p>
      <p style="margin:14px 0 6px;font-size:38px;line-height:1.1;font-style:italic;color:#2F2E2B;">Julia &amp; Jérémy</p>
      <p style="margin:0;font-size:12px;letter-spacing:4px;text-transform:uppercase;color:#5F5A51;">se căsătoresc</p>
      <p style="margin:18px 0 0;font-size:17px;letter-spacing:2px;text-transform:uppercase;color:#2F2E2B;">Sâmbătă, 23 octombrie 2027</p>
      <p style="margin:6px 0 0;font-size:15px;font-style:italic;color:#5F5A51;">Castelul Pontarmé — Oise, Franța</p>
    </td></tr>
    ...
    <tr><td style="padding:24px 36px 0;font-family:Georgia,'Times New Roman',serif;font-size:16px;line-height:1.7;color:#2F2E2B;">
      <p style="margin:0 0 14px;">Bună ziua, {$prenom},</p>
      <p style="margin:0 0 14px;">Cu multă bucurie vă invităm la nunta noastră, <strong style="font-weight:normal;color:#B08D57;">sâmbătă, 23 octombrie 2027</strong>, la castelul Pontarmé.</p>
      <p style="margin:0 0 14px;">Pe site-ul nostru găsiți programul zilei, locurile de cazare din apropiere și formularul pentru confirmarea prezenței.</p>
    </td></tr>

    <tr><td align="center" style="padding:26px 36px 8px;">
      <table role="presentation" cellpadding="0" cellspacing="0"><tr>
        <td align="center" bgcolor="#2F2E2B" style="border-radius:2px;">
          <a href="{$url}" style="display:inline-block;padding:16px 34px;font-family:Georgia,'Times New Roman',serif;font-size:13px;letter-spacing:3px;text-transform:uppercase;color:#FFFCF6;text-decoration:none;">Îmi confirm prezența</a>
        </td>
      </tr></table>
    </td></tr>

    <tr><td align="center" style="padding:6px 36px 0;font-family:Georgia,'Times New Roman',serif;font-size:12px;color:#5F5A51;">
      <p style="margin:0 0 4px;">Dacă butonul nu funcționează, copiați acest link:</p>
    ...
    <tr><td style="padding:24px 36px 0;font-family:Georgia,'Times New Roman',serif;font-size:14px;line-height:1.7;color:#5F5A51;">
      <p style="margin:0 0 10px;padding:14px 16px;background:#F7F3EC;border-left:2px solid #C9AE7C;">Acest link este <strong style="font-weight:normal;color:#2F2E2B;">personal</strong>: vă deschide formularul și vă permite să adăugați persoanele care vă însoțesc. Vă rugăm să nu îl transmiteți mai departe.</p>
      <p style="margin:14px 0 0;">Vă rugăm să ne răspundeți până pe <strong style="font-weight:normal;color:#2F2E2B;">{$deadline}</strong>.</p>
      <p style="margin:14px 0 0;">Abia așteptăm să vă avem alături,<br>Julia &amp; Jérémy</p>
    </td></tr>
...
$text = <<<TEXT
JULIA & JÉRÉMY — REZERVAȚI DATA
Sâmbătă, 23 octombrie 2027 — Castelul Pontarmé (Oise, Franța)

Bună ziua, {$guest['firstname']},

Cu multă bucurie vă invităm la nunta noastră,
sâmbătă, 23 octombrie 2027, la castelul Pontarmé.

Pe site-ul nostru găsiți programul zilei, locurile de cazare din apropiere
și formularul pentru confirmarea prezenței:

{$link}

Acest link este personal: vă deschide formularul și vă permite să adăugați
persoanele care vă însoțesc. Vă rugăm să nu îl transmiteți mai departe.

Vă rugăm să ne răspundeți până pe {$deadline}.
